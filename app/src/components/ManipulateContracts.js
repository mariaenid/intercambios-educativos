...
class ManipulateContracts extends Component {
...
ManipulateContracts.contextTypes = {
  drizzle: PropTypes.object,
};

ManipulateContracts.propTypes = {
...
export default drizzleConnect(ManipulateContracts, mapStateToProps);
